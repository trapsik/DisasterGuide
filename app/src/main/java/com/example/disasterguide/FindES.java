...
public class FindES extends AppCompatActivity implements OnMapReadyCallback {
    ...
    double cur_lat = 36.85118;//위도
    double cur_lon = 127.15113;//경도
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tvTitle = (TextView) findViewById(R.id.listTitle);
        back = (ImageView) findViewById(R.id.back);

        tvTitle.setText("지진대피소");
        ...
        tvSearchBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    String url = "location/earthquake?address=" + edtSearchLocation.getText().toString();
                    ...
                    ListViewAdapterCDS lva = new ListViewAdapterCDS("면적(m²)");
        ...
        tvFindNearLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    String url = "location/earthquake/near?x=" + cur_lon + "&y=" + cur_lat;
                    String result = new HttpResult().execute(url).get();
                    ArrayList<LocationModel> e = new ObjectMapper().readValue(result, new TypeReference<ArrayList<LocationModel>>(){});
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        try {
            for (int i = 0; i < locationList.size(); i++) {
                ...
                first = new LatLng(cur_lat,cur_lon);
